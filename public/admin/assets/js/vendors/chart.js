...
!(function (t, e) {
	...
	var Ce = {
		modes: {
			...
			nearest: (t, e, i, n) =>
				Pe(t, we(e, t), i.axis || "xy", i.intersect, n),
	...
	class Ti {
		...
		applyStack(t, e, i) {
			const n = this.chart,
				...
				s = e[t.axis];
			return Mi(
				{ keys: wi(n, !0), values: e._stacks[t.axis] },
				s,
				o.index,
				{ mode: i }
			);
		...
		_resolveElementOptions(t, e = "default", i) {
			...
			return (
				g.$shared &&
					((g.$shared = l), (s[a] = Object.freeze(Ai(g, l)))),
				g
			);
		}
	...
	class Yi extends Ri {
		...
		_computeLabelItems(t) {
			...
			let x,
				...
				O = "middle";
			if ("top" === o)
				(w = e.bottom - g), (M = e._getXAxisLabelAlignment());
			else if ("bottom" === o)
			...
			? (function (t, e, i) {
					...
					for (const r of t) {
						...
						for (a = s + 1; a <= r.end; a++) {
							const h = e[a % n];
							(l = kn(
								i.setContext({ type: "segment", p0: c, p1: h })
							)),
								Sn(l, t) &&
									(o.push({
										start: s,
	...
	function jn(t, e) {
		return (
			"top" === t || "bottom" === t || (-1 === Hn.indexOf(t) && "x" === e)
		);
	}
	function $n(t, e) {
		return function (i, n) {
		...
		_initialize() {
			...
			return (
				...
				t.options.responsive
					? t.resize()
					: _e(t, t.options.devicePixelRatio),
				t.bindEvents(),
			...
			i &&
				...
				J(s, (i) => {
					const s = i.options,
						...
						l = K(s.type, i.dtype);
					(void 0 !== s.position &&
						jn(s.position, r) === jn(i.dposition)) ||
	...
	class To extends Ri {
		...
		get segments() {
			return (
				this._segments ||
				(this._segments = wn(this, this.options.segment))
			);
		}
		first() {
	...
	var cs = {
		...
		afterDatasetsUpdate(t, e, i) {
			...
			for (a = 0; a < n; ++a)
				(l = o[a]),
					l && !1 !== l.fill && (l.fill = es(o, a, i.propagate));
		},
	...
	class Ps extends Ri {
		...
		getTitle(t, e) {
			...
			let r = [];
			return (
				(r = ms(r, xs(o))), (r = ms(r, xs(s))), (r = ms(r, xs(a))), r
			);
		}
		getBeforeBody(t, e) {
			...
			return (
				...
				(t._majorUnit =
					n.major.enabled && "year" !== t._unit
						? (function (t) {
								for (
									let e = js.indexOf(t) + 1, i = js.length;
									e < i;
									++e
								)
